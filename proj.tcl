...
# Source Block Design.
set file "[file normalize "$origin_dir/bd/reschan.tcl"]"
source $file

#set file "[file normalize "$origin_dir/bd/reschan_2019.2.tcl"]"
#source $file
...
# Create HDL Wrapper.
make_wrapper -files [get_files reschan.bd] -top

# Add files to sources_1 fileset
set files [list \
  [file normalize "${origin_dir}/top/top.srcs/sources_1/bd/d_1/hdl/reschan_wrapper.v" ]\
]
add_files -fileset $obj $files
